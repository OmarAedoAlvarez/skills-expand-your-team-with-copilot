document.addEventListener("DOMContentLoaded", () => {
  ...
  function renderActivityCard(name, details) {
    ...
    // Create difficulty badge if difficulty_level is specified
    const difficultyBadge = details.difficulty_level ? `
      <p class="difficulty-badge">
        <strong>Level:</strong> <span class="difficulty-level difficulty-${details.difficulty_level.toLowerCase()}">${details.difficulty_level}</span>
      </p>
    ` : '';
